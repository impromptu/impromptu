...
/**
 * Indicates whether cached values should attempt to update their contents.
 *
 * NOTE: The "refresh" event is only utilized by the base Cache class.
 * Should we continue to use an event?
 */
Impromptu.prototype.refresh = function() {
  this.emit('refresh')
}
