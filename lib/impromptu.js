...
util.inherits(Impromptu, EventEmitter)
...
Impromptu.prototype.fallback = function(message) {
...
Impromptu.prototype.path = function (name) {
  ...
  switch (name) {
    ...
    case 'serverPid':
      ...
      return serverId ? root + "/.compiled/server-" + serverId + ".pid" : ''
    case 'nodeModules':
...
(function () {
  ...
  Impromptu.prototype.setGlobalImpromptu = function (impromptuInstance) {
