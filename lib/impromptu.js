...
function Impromptu() {
  ...
  this.cache = new Impromptu.CacheFactory(this)
...
Impromptu.prototype._addCacheProviders = function () {
  this.cache.addProvider('global', function (name, options) {
    return new Impromptu.Cache.GlobalCache(this, name, options)
  }.bind(this))
  ...
  this.cache.addProvider('directory', function (name, options) {
    ...
    return new Impromptu.Cache.DirectoryCache(this, name, options)
  }.bind(this))

  this.cache.addProvider('repository', function (name, options) {
    return new Impromptu.Cache.RepositoryCache(this, name, options)
  }.bind(this))
}
...
Impromptu.CacheFactory = require('./cache-factory')
